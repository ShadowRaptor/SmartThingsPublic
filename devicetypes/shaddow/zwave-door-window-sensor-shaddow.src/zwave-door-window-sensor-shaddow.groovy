...
metadata {
	definition(name: "Z-Wave Door/Window Sensor Shaddow", namespace: "shaddow", author: "Shaddow", ocfDeviceType: "x.com.st.d.sensor.contact", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, genericHandler: "Z-Wave") {
		...
		fingerprint mfr: "0060", prod: "0002", model: "0001", deviceJoinName: "Everspring Open/Closed Sensor" //US & EU //Everspring Door/Window Sensor
